...
<title><?php echo $title;?> | Eclass </title>
...
<section id="title-header">
  <div class="title">  
     Eclass <br>
      ...
      <p class="subtitle"> Computer Aided Learning</p> 
  </div>
  ...
  <div id="mySidenav" class="sidenav">
     ...
     <a href="<?php echo web_root; ?>index2.php?q=exercises" id="exercise">Exercises</a>
    <a href="<?php echo web_root; ?>index2.php?q=download" id="download">Download</a>
 
    <a href="<?php echo web_root; ?>index2.php?q=lesson" id="lesson">Lesson <i class="fa fa-home"></i></a> 
  </div>
...
<footer  >
    <p align="left">&copy;<a href="http//www.mechetenco.com"> MECHETENCO</a> 2020 </p>
</footer>
</section>
